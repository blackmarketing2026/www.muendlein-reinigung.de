...
module.exports = async function handler(req, res) {
  ...
  const tableRows = detailRows.map(function (r) {
    return '<tr>' +
  ...
  const replySubject = encodeURIComponent('Re: Ihre Reinigungsanfrage');
  const replyBody = encodeURIComponent('Guten Tag ' + Name + ',\n\nvielen Dank für Ihre Anfrage.\n\n');
